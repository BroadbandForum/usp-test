...
<li><a href="#test-setup">4. Test Setup</a><ul>
<li><a href="#test-equipment">4.1 Test Equipment</a></li>
<li><a href="#test-setup-and-execution">4.2 Test Setup and Execution</a><ul>
<li><a href="#basic-test-setup">4.2.1 Basic Test Setup</a></li>
<li><a href="#mandatory-vs.-conditional-mandatory-tests">4.2.1 Mandatory vs. Conditional Mandatory Tests</a></li>
<li><a href="#endpoint-requirements-and-metadata-collection">4.2.2 Endpoint Requirements and Metadata Collection</a></li>
<li><a href="#clean-up-procedures">4.2.3 Clean-Up Procedures</a></li>
</ul></li>
<li><a href="#universal-test-metrics">4.3 Universal Test Metrics</a></li>
<li><a href="#notes-about-test-case-descriptions">4.4 Notes about test case descriptions</a><ul>
<li><a href="#use-of-examples">4.4.1 Use of examples</a></li>
</ul></li>
</ul></li>
<li><a href="#usp-agent-test-cases">5. USP Agent Test Cases</a><ul>
<li><a href="#messages-and-path-names">5.1 Messages and Path Names</a><ul>
<li><a href="#add-message-with-allow-partial-false-single-object-required-parameters-succeed">5.1.1 Add message with allow partial false, single object, required parameters succeed</a></li>
<li><a href="#add-message-with-allow-partial-true-single-object-required-parameters-succeed">5.1.2 Add message with allow partial true, single object, required parameters succeed</a></li>
<li><a href="#add-message-with-allow-partial-false-single-object-required-parameters-fail">5.1.3 Add message with allow partial false, single object, required parameters fail</a></li>
<li><a href="#add-message-with-allow-partial-false-single-invalid-object">5.1.4 Add message with allow partial false, single invalid object</a></li>
<li><a href="#add-message-with-allow-partial-false-multiple-objects">5.1.5 Add message with allow partial false, multiple objects</a></li>
<li><a href="#add-message-with-allow-partial-false-multiple-objects-with-an-invalid-object">5.1.6 Add message with allow partial false, multiple objects with an invalid object</a></li>
<li><a href="#add-message-with-allow-partial-false-multiple-objects-required-parameters-fail-in-single-object">5.1.7 Add message with allow partial false, multiple objects, required parameters fail in single object</a></li>
<li><a href="#add-message-with-allow-partial-true-required-parameters-fail-invalid-value-single-object">5.1.8 Add message with allow partial true, required parameters fail, invalid value, single object</a></li>
<li><a href="#add-message-with-allow-partial-true-required-parameters-fail-multiple-objects">5.1.9 Add message with allow partial true, required parameters fail, multiple objects</a></li>
<li><a href="#add-message-with-unique-key-addressing-in-path">5.1.10 Add message with unique key addressing in path</a></li>
<li><a href="#set-message-with-allow-partial-false-required-parameters-pass">5.1.11 Set message with allow partial false, required parameters pass</a></li>
<li><a href="#set-message-with-allow-partial-true-required-parameters-pass">5.1.12 Set message with allow partial true, required parameters pass</a></li>
<li><a href="#set-message-with-allow-partial-false-multiple-objects">5.1.13 Set message with allow partial false, multiple objects</a></li>
<li><a href="#set-message-with-allow-partial-false-required-parameters-fail">5.1.14 Set message with allow partial false, required parameters fail</a></li>
<li><a href="#set-message-with-allow-partial-false-multiple-objects-required-parameters-fail-in-single-object">5.1.15 Set message with allow partial false, multiple objects, required parameters fail in single object</a></li>
<li><a href="#set-message-with-allow-partial-true-required-parameter-fails-multiple-objects">5.1.16 Set message with allow partial true, required parameter fails, multiple objects</a></li>
<li><a href="#set-message-with-allow-partial-true-non-required-parameter-fails-multiple-parameters">5.1.17 Set message with allow partial true, non-required parameter fails, multiple parameters</a></li>
<li><a href="#set-message-with-unique-key-addressing-in-path">5.1.18 Set message with unique key addressing in path</a></li>
<li><a href="#set-message-with-wildcard-search-path-allow-partial-false-required-parameters-pass">5.1.19 Set message with wildcard search path, allow partial false, required parameters pass</a></li>
<li><a href="#set-message-with-wildcard-search-path-allow-partial-false-required-parameters-fail">5.1.20 Set message with wildcard search path, allow partial false, required parameters fail</a></li>
<li><a href="#set-message-with-wildcard-search-path-allow-partial-true-required-parameters-fail">5.1.21 Set message with wildcard search path, allow partial true, required parameters fail</a></li>
<li><a href="#set-message-with-search-expression-search-path">5.1.22 Set message with search expression search path</a></li>
<li><a href="#set-message-with-invalid-path">5.1.23 Set message with invalid path</a></li>
<li><a href="#delete-message-with-allow-partial-false-valid-object-instance">5.1.24 Delete message with allow partial false, valid object instance</a></li>
<li><a href="#delete-message-with-allow-partial-false-object-instance-doesnt-exist">5.1.25 Delete message with allow partial false, object instance doesn’t exist</a></li>
<li><a href="#delete-message-with-allow-partial-false-invalid-object">5.1.26 Delete message with allow partial false, invalid object</a></li>
<li><a href="#delete-message-with-allow-partial-false-multiple-objects">5.1.27 Delete message with allow partial false, multiple objects</a></li>
<li><a href="#delete-message-with-allow-partial-false-multiple-objects-invalid-object">5.1.28 Delete message with allow partial false, multiple objects, invalid object</a></li>
<li><a href="#delete-message-with-allow-partial-true-object-instance-doesnt-exist">5.1.29 Delete message with allow partial true, object instance doesn’t exist</a></li>
<li><a href="#delete-message-with-allow-partial-true-invalid-object">5.1.30 Delete message with allow partial true, invalid object</a></li>
<li><a href="#delete-message-with-allow-partial-true-multiple-objects-invalid-object">5.1.31 Delete message with allow partial true, multiple objects, invalid object</a></li>
<li><a href="#delete-message-with-allow-partial-true-multiple-objects-object-doesnt-exist">5.1.32 Delete message with allow partial true, multiple objects, object doesn’t exist</a></li>
<li><a href="#delete-message-with-unique-key-addressing">5.1.33 Delete message with unique key addressing</a></li>
<li><a href="#delete-message-with-wildcard-search-path-valid-objects">5.1.34 Delete message with wildcard search path, valid objects</a></li>
<li><a href="#delete-message-with-search-expression-search-path">5.1.35 Delete message with search expression search path</a></li>
<li><a href="#get-message-with-full-parameter-path">5.1.36 Get message with full parameter path</a></li>
<li><a href="#get-message-with-multiple-full-parameter-paths-same-object">5.1.37 Get message with multiple full parameter paths, same object</a></li>
<li><a href="#get-message-with-multiple-full-parameter-paths-different-objects">5.1.38 Get message with multiple full parameter paths, different objects</a></li>
<li><a href="#get-message-with-object-path">5.1.39 Get message with object path</a></li>
<li><a href="#get-message-with-object-instance-path">5.1.40 Get message with object instance path</a></li>
<li><a href="#get-message-with-invalid-parameter">5.1.41 Get message with invalid parameter</a></li>
<li><a href="#get-message-with-invalid-parameter-and-valid-parameter">5.1.42 Get message with invalid parameter and valid parameter</a></li>
<li><a href="#get-message-using-unique-key-addressing">5.1.43 Get message using unique key addressing</a></li>
<li><a href="#get-message-using-wildcard-search-path-on-full-parameter">5.1.44 Get message using wildcard search path on full parameter</a></li>
<li><a href="#get-message-using-wildcard-search-path-on-object-path">5.1.45 Get message using wildcard search path on object path</a></li>
<li><a href="#get-message-using-search-expression-search-path-equivalence">5.1.46 Get message using search expression search path (equivalence)</a></li>
<li><a href="#get-message-using-search-expression-search-path-non-equivelance">5.1.47 Get message using search expression search path (non-equivelance)</a></li>
<li><a href="#get-message-using-search-expression-search-path-exclusive-greater-comparison">5.1.48 Get message using search expression search path (exclusive greater comparison)</a></li>
<li><a href="#get-message-using-search-expression-search-path-exclusive-lesser-comparison">5.1.49 Get message using search expression search path (exclusive lesser comparison)</a></li>
<li><a href="#get-message-using-search-expression-search-path-inclusive-greater-comparison">5.1.50 Get message using search expression search path (inclusive greater comparison)</a></li>
<li><a href="#get-message-using-search-expression-search-path-inclusive-lesser-comparison">5.1.51 Get message using search expression search path (inclusive lesser comparison)</a></li>
<li><a href="#notify---subscription-creation-using-value-change">5.1.52 Notify - Subscription creation using Value Change</a></li>
<li><a href="#notify---subscription-deletion-using-value-change">5.1.53 Notify - Subscription Deletion Using Value Change</a></li>
<li><a href="#notification-retry-using-value-change">5.1.54 Notification Retry using Value Change</a></li>
<li><a href="#subscription-expiration-using-value-change">5.1.55 Subscription Expiration using Value Change</a></li>
<li><a href="#notification-retry-expiration-using-value-change">5.1.56 Notification Retry Expiration using Value Change</a></li>
<li><a href="#objectcreation-notification">5.1.57 ObjectCreation Notification</a></li>
<li><a href="#objectdeletion-notification">5.1.58 ObjectDeletion Notification</a></li>
<li><a href="#event-notification-using-periodic">5.1.59 Event Notification using Periodic!</a></li>
...
<li><a href="#onboardrequest-notification">5.1.60 OnBoardRequest Notification</a></li>
<li><a href="#operate-message-using-reboot-with-send_resp-true">5.1.61 Operate message using Reboot() with send_resp true</a></li>
<li><a href="#operate-message-using-reboot-with-send_resp-false">5.1.62 Operate message using Reboot() with send_resp false</a></li>
<li><a href="#operate-message-using-input-arguments">5.1.63 Operate message using input arguments</a></li>
<li><a href="#asynchronous-operation-with-send_resp-true">5.1.64 Asynchronous operation with send_resp true</a></li>
<li><a href="#asynchronous-operation-with-send_resp-false">5.1.65 Asynchronous operation with send_resp false</a></li>
<li><a href="#getinstances-using-a-single-object-first_level_only-true">5.1.66 GetInstances using a single object, first_level_only true</a></li>
<li><a href="#getinstances-using-a-single-object-first_level_only-false">5.1.67 GetInstances using a single object, first_level_only false</a></li>
<li><a href="#getinstances-with-multiple-objects">5.1.68 GetInstances with multiple objects</a></li>
<li><a href="#getinstances-with-root-object">5.1.69 GetInstances with root object</a></li>
<li><a href="#getinstances-with-wildcard-search-path">5.1.70 GetInstances with wildcard search path</a></li>
<li><a href="#getinstances-with-search-expression-search-path">5.1.71 GetInstances with search expression search path</a></li>
<li><a href="#getsupporteddm-using-a-single-object-first_level_only-false-all-options">5.1.72 GetSupportedDM using a single object, first_level_only false, all options</a></li>
<li><a href="#getsupporteddm-using-a-single-object-first_level_only-true-all-options">5.1.73 GetSupportedDM using a single object, first_level_only true, all options</a></li>
<li><a href="#getsupporteddm-using-a-single-object-first_level_only-true-no-options">5.1.74 GetSupportedDM using a single object, first_level_only true, no options</a></li>
<li><a href="#getsupporteddm-using-multiple-objects-first_level_only-true-all-options">5.1.75 GetSupportedDM using multiple objects, first_level_only true, all options</a></li>
<li><a href="#getsupporteddm-on-root-object-all-options">5.1.76 GetSupportedDM on root object, all options</a></li>
<li><a href="#getsupporteddm-on-unsupported-object">5.1.77 GetSupportedDM on unsupported object</a></li>
</ul></li>
<li><a href="#authentication-and-access-control-test-cases">5.2 Authentication and Access Control Test Cases</a><ul>
<li><a href="#agent-does-not-accept-messages-from-its-own-endpoint-id">5.2.1 Agent does not accept messages from its own Endpoint ID</a></li>
<li><a href="#agent-rejects-messages-that-do-not-contain-its-to_id-in-the-usp-record">5.2.2 Agent rejects messages that do not contain its to_id in the USP Record</a></li>
<li><a href="#agent-does-not-process-messages-without-s-certificate-information">5.2.3 Agent does not process messages without ’s certificate information</a></li>
<li><a href="#agent-rejects-messages-from-endpoint-ids-that-are-not-in-subjectaltname">5.2.4 Agent rejects messages from Endpoint IDs that are not in subjectAltName</a></li>
<li><a href="#agent-use-of-self-signed-certificates">5.2.5 Agent use of self-signed certificates</a></li>
<li><a href="#connecting-without-absolute-time">5.2.6 Connecting without absolute time</a></li>
<li><a href="#agent-ignores-unsigned-or-invalid-record-signatures">5.2.7 Agent ignores unsigned or invalid Record signatures</a></li>
<li><a href="#agent-ignores-invalid-tls-certificate">5.2.8 Agent ignores invalid TLS certificate</a></li>
<li><a href="#use-of-the-untrusted-role">5.2.9 Use of the Untrusted role</a></li>
<li><a href="#adding-a-role">5.2.10 Adding a Role</a></li>
<li><a href="#permissions---object-creation-allowed">5.2.11 Permissions - Object Creation Allowed</a></li>
<li><a href="#permissions---object-creation-not-allowed">5.2.12 Permissions - Object Creation Not Allowed</a></li>
<li><a href="#permissions---object-deletion-allowed">5.2.13 Permissions - Object Deletion Allowed</a></li>
<li><a href="#permissions---object-deletion-not-allowed">5.2.14 Permissions - Object Deletion Not Allowed</a></li>
<li><a href="#permissions---parameter-update-allowed">5.2.15 Permissions - Parameter Update Allowed</a></li>
<li><a href="#permissions---parameter-update-not-allowed">5.2.16 Permissions - Parameter Update Not Allowed</a></li>
<li><a href="#permissions---operation-allowed">5.2.17 Permissions - Operation Allowed</a></li>
<li><a href="#permissions---operation-not-allowed">5.2.18 Permissions - Operation Not Allowed</a></li>
<li><a href="#permissions---value-change-notification-allowed-on-parameter">5.2.19 Permissions - Value Change Notification Allowed on Parameter</a></li>
<li><a href="#permissions---value-change-notification-not-allowed-on-parameter">5.2.20 Permissions - Value Change Notification Not Allowed on Parameter</a></li>
<li><a href="#permissions---overlapping-permissions">5.2.21 Permissions - Overlapping Permissions</a></li>
<li><a href="#using-get-when-no-read-permissions-are-available-on-some-parameters">5.2.22 Using Get when no read permissions are available on some parameters</a></li>
</ul></li>
<li><a href="#usp-record-test-cases">5.9 USP Record Test Cases</a><ul>
<li><a href="#bad-request-outside-a-session-context">5.3.1 Bad request outside a session context</a></li>
<li><a href="#agent-protects-usp-record-integrity-when-mtp-protection-is-not-present">5.3.2 Agent protects USP Record integrity when MTP protection is not present</a></li>
<li><a href="#agent-verifies-non-payload-field-integrity">5.3.3 Agent Verifies Non-Payload Field Integrity</a></li>
<li><a href="#using-tls-for-usp-record-integrity">5.3.4 Using TLS for USP Record Integrity</a></li>
<li><a href="#failure-to-establish-tls">5.3.5 Failure to Establish TLS</a></li>
<li><a href="#agent-ignores-tls-renegotiation-for-e2e-message-exchange">5.3.6 Agent ignores TLS renegotiation for E2E message exchange</a></li>
<li><a href="#use-of-x.509-certificates">5.3.7 Use of X.509 Certificates</a></li>
<li><a href="#establishing-a-session-context">5.3.8 Establishing a Session Context</a></li>
<li><a href="#receipt-of-a-record-out-of-a-session-context">5.3.9 Receipt of a Record out of a Session Context</a></li>
<li><a href="#session-context-expiration">5.3.10 Session Context Expiration</a></li>
<li><a href="#use-of-sequence-id-and-expected-id">5.3.11 Use of Sequence ID and Expected ID</a></li>
<li><a href="#preservation-of-usp-records">5.3.12 Preservation of USP Records</a></li>
<li><a href="#agent-rejects-records-with-different-payload-security-than-the-established-context">5.3.13 Agent Rejects Records with Different Payload Security than the Established Context</a></li>
<li><a href="#use-of-retransmit_id">5.3.14 Use of retransmit_id</a></li>
<li><a href="#handling-duplicate-records">5.3.15 Handling Duplicate Records</a></li>
</ul></li>
<li><a href="#general-mtp-test-cases">5.4 General MTP Test Cases</a><ul>
<li><a href="#use-of-x.509-certificates-at-the-mtp-layer">5.4.1 Use of X.509 certificates at the MTP layer</a></li>
</ul></li>
<li><a href="#coap-test-cases">5.5 CoAP Test Cases</a><ul>
<li><a href="#mapping-a-usp-record-to-a-coap-message">5.5.1 Mapping a USP Record to a CoAP message</a></li>
<li><a href="#usp-records-that-exceed-coap-message-size">5.5.2 USP Records that exceed CoAP message size</a></li>
<li><a href="#successful-coap-exchange">5.5.3 Successful CoAP exchange</a></li>
<li><a href="#failed-coap-exchange---timeout">5.5.4 Failed CoAP exchange - timeout</a></li>
<li><a href="#failed-coap-exchange---invalid-method">5.5.5 Failed CoAP Exchange - Invalid Method</a></li>
<li><a href="#failed-coap-exchange---invalid-content-format">5.5.6 Failed CoAP Exchange - Invalid Content-Format</a></li>
<li><a href="#failed-coap-exchange---invalid-usp-record">5.5.7 Failed CoAP Exchange - Invalid USP Record</a></li>
<li><a href="#use-of-dtls">5.5.8 Use of DTLS</a></li>
</ul></li>
<li><a href="#stomp-test-cases">5.6 STOMP Test Cases</a><ul>
<li><a href="#support-of-required-profiles">5.6.1 Support of Required Profiles</a></li>
<li><a href="#stomp-session-establishment">5.6.2 STOMP session establishment</a></li>
<li><a href="#stomp-connection-retry">5.6.3 STOMP Connection Retry</a></li>
<li><a href="#successful-usp-message-over-stomp-with-required-headers">5.6.4 Successful USP message over STOMP with required headers</a></li>
<li><a href="#stomp-destination---provided-in-subscribe-dest">5.6.5 STOMP destination - provided in subscribe-dest</a></li>
<li><a href="#stomp-destination---configured-in-usp-data-model">5.6.6 STOMP destination - configured in USP data model</a></li>
<li><a href="#stomp-destination---terminates-unconfigured-session">5.6.7 STOMP Destination - terminates unconfigured session</a></li>
<li><a href="#use-of-stomp-heartbeat-mechanism">5.6.8 Use of STOMP heartbeat mechanism</a></li>
<li><a href="#error-handling---unprocessed-record">5.6.9 Error Handling - Unprocessed Record</a></li>
<li><a href="#agents-stomp-destination-is-changed">5.6.10 Agent’s STOMP destination is changed</a></li>
<li><a href="#stomp---use-of-tls">5.6.11 STOMP - Use of TLS</a></li>
</ul></li>
<li><a href="#websocket-test-cases">5.7 WebSocket Test Cases</a><ul>
<li><a href="#session-establishment">5.7.1 Session Establishment</a></li>
<li><a href="#use-of-only-one-session">5.7.2 Use of only one session</a></li>
<li><a href="#agent-session-acceptance-from-controller">5.7.3 Agent session acceptance from Controller</a></li>
<li><a href="#closing-a-websocket-connection">5.7.4 Closing a WebSocket Connection</a></li>
<li><a href="#rejection-of-session-establishment">5.7.5 Rejection of Session Establishment</a></li>
<li><a href="#error-handling---unprocessed-records">5.7.6 Error Handling - Unprocessed Records</a></li>
<li><a href="#use-of-ping-and-pong-frames">5.7.7 Use of Ping and Pong frames</a></li>
<li><a href="#websocket-session-retry">5.7.8 WebSocket Session Retry</a></li>
<li><a href="#use-of-tls">5.7.9 Use of TLS</a></li>
</ul></li>
<li><a href="#discovery-test-cases">5.8 Discovery Test Cases</a><ul>
<li><a href="#dhcp-discovery---agent-request-requirements">5.8.1 DHCP Discovery - Agent Request Requirements</a></li>
<li><a href="#dhcp-discovery---agent-handling-of-recieved-options">5.8.2 DHCP Discovery - Agent handling of recieved options</a></li>
<li><a href="#dhcp-discovery---fqdn-leads-to-dns-query">5.8.3 DHCP Discovery - FQDN Leads to DNS Query</a></li>
<li><a href="#mdns">5.8.4 mDNS</a></li>
<li><a href="#mdns-and-message-transfer-protocols">5.8.5 mDNS and Message Transfer Protocols</a></li>
<li><a href="#dns---resolving-non-local-endpoints">5.8.6 DNS - Resolving non-local endpoints</a></li>
<li><a href="#dns---unknown-resource-path">5.8.7 DNS - Unknown Resource Path</a></li>
<li><a href="#dns---dns-record-requirements">5.8.8 DNS - DNS Record Requirements</a></li>
</ul></li>
<li><a href="#functionality-test-cases">5.9 Functionality Test Cases</a><ul>
<li><a href="#use-of-the-timer-event">5.9.1 Use of the Timer! Event</a></li>
<li><a href="#use-of-device.localagent.addcertificate">5.9.2 Use of Device.LocalAgent.AddCertificate()</a></li>
<li><a href="#upgraded-the-agents-firmware---autoactivate-enabled">5.9.3 Upgraded the Agent’s Firmware - Autoactivate enabled</a></li>
<li><a href="#upgrading-the-agents-firmware---using-timewindow-immediate">5.9.4 Upgrading the Agent’s Firmware - Using TimeWindow, Immediate</a></li>
<li><a href="#upgrading-the-agents-firmware---using-timewindow-anytime">5.9.5 Upgrading the Agent’s Firmware - Using TimeWindow, AnyTime</a></li>
<li><a href="#upgrading-the-agents-firmware---validated-firmware">5.9.6 Upgrading the Agent’s Firmware - Validated Firmware</a></li>
<li><a href="#upgrading-the-agents-firmware---download-to-active-bank">5.9.7 Upgrading the Agent’s Firmware - Download to Active Bank</a></li>
<li><a href="#upgrading-the-agents-firmware---cancelling-a-request-using-the-cancel-command">5.9.8 Upgrading the Agent’s Firmware - Cancelling a request using the Cancel() command</a></li>
<li><a href="#adding-a-new-controller---onboardrequest">5.9.9 Adding a New Controller - OnBoardRequest</a></li>
<li><a href="#use-of-the-boot-event-and-bootparameters">5.9.10 Use of the Boot! event and BootParameters</a></li>
</ul></li>
</ul></li>
</ul>
</nav>
...
<h1 id="test-setup">4. Test Setup</h1>
<h2 id="test-equipment">4.1 Test Equipment</h2>
...
<h2 id="test-setup-and-execution">4.2 Test Setup and Execution</h2>
<h3 id="basic-test-setup">4.2.1 Basic Test Setup</h3>
<figure>
<img src="./figure-1.png" alt="Figure 1" /><figcaption>Figure 1</figcaption>
</figure>
<h3 id="mandatory-vs.-conditional-mandatory-tests">4.2.1 Mandatory vs. Conditional Mandatory Tests</h3>
...
<p>Tests that are conditional mandatory and have a particular parameter, command, event, or profile requirement, a different subject can be substituted that meets the needs of the test. For example, if an EUT does not support the Reboot:1 profile, another synchronous operation can be substituted for tests 5.1.61 and 5.1.62.</p>
<h3 id="endpoint-requirements-and-metadata-collection">4.2.2 Endpoint Requirements and Metadata Collection</h3>
<h4 id="required-profiles">4.2.2.1 Required Profiles</h4>
...
<h5 id="additional-test-cases-required-by-profile-and-option-support">4.2.2.1.1 Additional Test Cases Required by Profile and Option Support</h5>
...
<td style="text-align: left;">5.1.59</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">7</td>
<td style="text-align: left;">Controller:1 profile (writeable)</td>
<td style="text-align: left;">5.9.9</td>
...
<td style="text-align: left;">5.1.60</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">9</td>
<td style="text-align: left;">Device.LocalAgent.Controller.{i}.ScheduleTimer()</td>
<td style="text-align: left;">5.1.64, 5.1.65, 5.9.1</td>
<td style="text-align: left;"></td>
</tr>
<tr class="odd">
<td style="text-align: left;">10</td>
<td style="text-align: left;">Reboot:1 profile</td>
<td style="text-align: left;">5.1.61, 5.1.62, 5.9.10</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">5.2.9, 5.2.10</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">13</td>
<td style="text-align: left;">ControllerTrust:1 profile (writeable)</td>
<td style="text-align: left;">5.2.4, 5.2.11, 5.2.12, 5.2.13, 5.2.14, 5.2.15, 5.2.16, 5.2.17, 5.2.18, 5.2.19, 5.2.20, 5.2.21, 5.2.22</td>
...
<td style="text-align: left;">CoAP Message Transport</td>
<td style="text-align: left;">5.5.*</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">17</td>
<td style="text-align: left;">STOMP Message Transport</td>
<td style="text-align: left;">5.6.*</td>
<td style="text-align: left;">Excludes 5.6.8 unless option 22 is supported</td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Excludes 5.7.3 unless option 24 is supported</td>
</tr>
<tr class="odd">
<td style="text-align: left;">20</td>
<td style="text-align: left;">TR-369 requirement R-WS.6</td>
<td style="text-align: left;">5.7.3</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">21</td>
<td style="text-align: left;">Discovery via DHCP Options</td>
<td style="text-align: left;">5.8.1, 5.8.2, 5.8.3</td>
<td style="text-align: left;"></td>
</tr>
<tr class="odd">
<td style="text-align: left;">22</td>
<td style="text-align: left;">Discovery via mDNS</td>
<td style="text-align: left;">5.8.4, 5.8.5, 5.8.7</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">23</td>
<td style="text-align: left;">Integrity protection at the USP layer</td>
<td style="text-align: left;">5.3.2, 5.3.3, 5.3.4, 5.3.5, 5.3.6, 5.3.7</td>
<td style="text-align: left;"></td>
</tr>
<tr class="odd">
<td style="text-align: left;">24</td>
<td style="text-align: left;">USP session context</td>
<td style="text-align: left;">5.3.8, 5.3.9, 5.3.10, 5.3.11, 5.3.12, 5.3.13, 5.3.14</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">5.9.3, 5.9.6, 5.9.7</td>
<td style="text-align: left;"></td>
</tr>
<tr class="even">
<td style="text-align: left;">27</td>
<td style="text-align: left;">Firmware:1 profile (Activate)</td>
<td style="text-align: left;">5.9.4</td>
...
<td style="text-align: left;">Applies only if option 14 is supported</td>
</tr>
</tbody>
</table>
<h4 id="elements-specified-in-the-test-procedure">4.2.2.2 Elements Specified in the Test Procedure</h4>
...
<h4 id="required-eut-information-and-resources">4.2.2.3 Required EUT Information and Resources</h4>
...
<li>The number of firmware banks available if the Firmware:1 profil is supported.</li>
...
<h3 id="clean-up-procedures">4.2.3 Clean-Up Procedures</h3>
...
<h2 id="universal-test-metrics">4.3 Universal Test Metrics</h2>
...
<h2 id="notes-about-test-case-descriptions">4.4 Notes about test case descriptions</h2>
...
<h3 id="use-of-examples">4.4.1 Use of examples</h3>
...
<h1 id="usp-agent-test-cases">5. USP Agent Test Cases</h1>
<h2 id="messages-and-path-names">5.1 Messages and Path Names</h2>
<h3 id="add-message-with-allow-partial-false-single-object-required-parameters-succeed">5.1.1 Add message with allow partial false, single object, required parameters succeed</h3>
...
<h3 id="add-message-with-allow-partial-true-single-object-required-parameters-succeed">5.1.2 Add message with allow partial true, single object, required parameters succeed</h3>
...
<h3 id="add-message-with-allow-partial-false-single-object-required-parameters-fail">5.1.3 Add message with allow partial false, single object, required parameters fail</h3>
...
<h3 id="add-message-with-allow-partial-false-single-invalid-object">5.1.4 Add message with allow partial false, single invalid object</h3>
...
<h3 id="add-message-with-allow-partial-false-multiple-objects">5.1.5 Add message with allow partial false, multiple objects</h3>
...
<h3 id="add-message-with-allow-partial-false-multiple-objects-with-an-invalid-object">5.1.6 Add message with allow partial false, multiple objects with an invalid object</h3>
...
<h3 id="add-message-with-allow-partial-false-multiple-objects-required-parameters-fail-in-single-object">5.1.7 Add message with allow partial false, multiple objects, required parameters fail in single object</h3>
...
<h3 id="add-message-with-allow-partial-true-required-parameters-fail-invalid-value-single-object">5.1.8 Add message with allow partial true, required parameters fail, invalid value, single object</h3>
...
<h3 id="add-message-with-allow-partial-true-required-parameters-fail-multiple-objects">5.1.9 Add message with allow partial true, required parameters fail, multiple objects</h3>
...
<h3 id="add-message-with-unique-key-addressing-in-path">5.1.10 Add message with unique key addressing in path</h3>
...
<h3 id="set-message-with-allow-partial-false-required-parameters-pass">5.1.11 Set message with allow partial false, required parameters pass</h3>
...
<h3 id="set-message-with-allow-partial-true-required-parameters-pass">5.1.12 Set message with allow partial true, required parameters pass</h3>
...
<h3 id="set-message-with-allow-partial-false-multiple-objects">5.1.13 Set message with allow partial false, multiple objects</h3>
...
<h3 id="set-message-with-allow-partial-false-required-parameters-fail">5.1.14 Set message with allow partial false, required parameters fail</h3>
...
<h3 id="set-message-with-allow-partial-false-multiple-objects-required-parameters-fail-in-single-object">5.1.15 Set message with allow partial false, multiple objects, required parameters fail in single object</h3>
...
<h3 id="set-message-with-allow-partial-true-required-parameter-fails-multiple-objects">5.1.16 Set message with allow partial true, required parameter fails, multiple objects</h3>
...
<h3 id="set-message-with-allow-partial-true-non-required-parameter-fails-multiple-parameters">5.1.17 Set message with allow partial true, non-required parameter fails, multiple parameters</h3>
...
<h3 id="set-message-with-unique-key-addressing-in-path">5.1.18 Set message with unique key addressing in path</h3>
...
<h3 id="set-message-with-wildcard-search-path-allow-partial-false-required-parameters-pass">5.1.19 Set message with wildcard search path, allow partial false, required parameters pass</h3>
...
<h3 id="set-message-with-wildcard-search-path-allow-partial-false-required-parameters-fail">5.1.20 Set message with wildcard search path, allow partial false, required parameters fail</h3>
...
<h3 id="set-message-with-wildcard-search-path-allow-partial-true-required-parameters-fail">5.1.21 Set message with wildcard search path, allow partial true, required parameters fail</h3>
...
<h3 id="set-message-with-search-expression-search-path">5.1.22 Set message with search expression search path</h3>
...
<h3 id="set-message-with-invalid-path">5.1.23 Set message with invalid path</h3>
...
<h3 id="delete-message-with-allow-partial-false-valid-object-instance">5.1.24 Delete message with allow partial false, valid object instance</h3>
...
<h3 id="delete-message-with-allow-partial-false-object-instance-doesnt-exist">5.1.25 Delete message with allow partial false, object instance doesn’t exist</h3>
...
<h3 id="delete-message-with-allow-partial-false-invalid-object">5.1.26 Delete message with allow partial false, invalid object</h3>
...
<h3 id="delete-message-with-allow-partial-false-multiple-objects">5.1.27 Delete message with allow partial false, multiple objects</h3>
...
<h3 id="delete-message-with-allow-partial-false-multiple-objects-invalid-object">5.1.28 Delete message with allow partial false, multiple objects, invalid object</h3>
...
<h3 id="delete-message-with-allow-partial-true-object-instance-doesnt-exist">5.1.29 Delete message with allow partial true, object instance doesn’t exist</h3>
...
<h3 id="delete-message-with-allow-partial-true-invalid-object">5.1.30 Delete message with allow partial true, invalid object</h3>
...
<h3 id="delete-message-with-allow-partial-true-multiple-objects-invalid-object">5.1.31 Delete message with allow partial true, multiple objects, invalid object</h3>
...
<h3 id="delete-message-with-allow-partial-true-multiple-objects-object-doesnt-exist">5.1.32 Delete message with allow partial true, multiple objects, object doesn’t exist</h3>
...
<h3 id="delete-message-with-unique-key-addressing">5.1.33 Delete message with unique key addressing</h3>
...
<h3 id="delete-message-with-wildcard-search-path-valid-objects">5.1.34 Delete message with wildcard search path, valid objects</h3>
...
<h3 id="delete-message-with-search-expression-search-path">5.1.35 Delete message with search expression search path</h3>
...
<h3 id="get-message-with-full-parameter-path">5.1.36 Get message with full parameter path</h3>
...
<h3 id="get-message-with-multiple-full-parameter-paths-same-object">5.1.37 Get message with multiple full parameter paths, same object</h3>
...
<h3 id="get-message-with-multiple-full-parameter-paths-different-objects">5.1.38 Get message with multiple full parameter paths, different objects</h3>
...
<h3 id="get-message-with-object-path">5.1.39 Get message with object path</h3>
...
<h3 id="get-message-with-object-instance-path">5.1.40 Get message with object instance path</h3>
...
<h3 id="get-message-with-invalid-parameter">5.1.41 Get message with invalid parameter</h3>
...
<h3 id="get-message-with-invalid-parameter-and-valid-parameter">5.1.42 Get message with invalid parameter and valid parameter</h3>
...
<h3 id="get-message-using-unique-key-addressing">5.1.43 Get message using unique key addressing</h3>
...
<h3 id="get-message-using-wildcard-search-path-on-full-parameter">5.1.44 Get message using wildcard search path on full parameter</h3>
...
<h3 id="get-message-using-wildcard-search-path-on-object-path">5.1.45 Get message using wildcard search path on object path</h3>
...
<h3 id="get-message-using-search-expression-search-path-equivalence">5.1.46 Get message using search expression search path (equivalence)</h3>
...
<h3 id="get-message-using-search-expression-search-path-non-equivelance">5.1.47 Get message using search expression search path (non-equivelance)</h3>
...
<h3 id="get-message-using-search-expression-search-path-exclusive-greater-comparison">5.1.48 Get message using search expression search path (exclusive greater comparison)</h3>
...
<h3 id="get-message-using-search-expression-search-path-exclusive-lesser-comparison">5.1.49 Get message using search expression search path (exclusive lesser comparison)</h3>
...
<h3 id="get-message-using-search-expression-search-path-inclusive-greater-comparison">5.1.50 Get message using search expression search path (inclusive greater comparison)</h3>
...
<h3 id="get-message-using-search-expression-search-path-inclusive-lesser-comparison">5.1.51 Get message using search expression search path (inclusive lesser comparison)</h3>
...
<h3 id="notify---subscription-creation-using-value-change">5.1.52 Notify - Subscription creation using Value Change</h3>
...
<h3 id="notify---subscription-deletion-using-value-change">5.1.53 Notify - Subscription Deletion Using Value Change</h3>
...
<h3 id="notification-retry-using-value-change">5.1.54 Notification Retry using Value Change</h3>
...
<h3 id="subscription-expiration-using-value-change">5.1.55 Subscription Expiration using Value Change</h3>
...
<h3 id="notification-retry-expiration-using-value-change">5.1.56 Notification Retry Expiration using Value Change</h3>
...
<h3 id="objectcreation-notification">5.1.57 ObjectCreation Notification</h3>
...
<h3 id="objectdeletion-notification">5.1.58 ObjectDeletion Notification</h3>
...
<h3 id="event-notification-using-periodic">5.1.59 Event Notification using Periodic!</h3>
...
<h3 id="onboardrequest-notification">5.1.60 OnBoardRequest Notification</h3>
...
<h3 id="operate-message-using-reboot-with-send_resp-true">5.1.61 Operate message using Reboot() with send_resp true</h3>
...
<h3 id="operate-message-using-reboot-with-send_resp-false">5.1.62 Operate message using Reboot() with send_resp false</h3>
...
<h3 id="operate-message-using-input-arguments">5.1.63 Operate message using input arguments</h3>
...
<h3 id="asynchronous-operation-with-send_resp-true">5.1.64 Asynchronous operation with send_resp true</h3>
...
<h3 id="asynchronous-operation-with-send_resp-false">5.1.65 Asynchronous operation with send_resp false</h3>
...
<h3 id="getinstances-using-a-single-object-first_level_only-true">5.1.66 GetInstances using a single object, first_level_only true</h3>
...
<h3 id="getinstances-using-a-single-object-first_level_only-false">5.1.67 GetInstances using a single object, first_level_only false</h3>
...
<ol type="1">
<li>The EUT sends a GetInstancesResp with one req_path_results elements containing a requested_path of Device.LocalAgent., and lists all instances of the Contrller object, plus any instances of all sub-objects.</li>
</ol>
<h3 id="getinstances-with-multiple-objects">5.1.68 GetInstances with multiple objects</h3>
...
<h3 id="getinstances-with-root-object">5.1.69 GetInstances with root object</h3>
...
<h3 id="getinstances-with-wildcard-search-path">5.1.70 GetInstances with wildcard search path</h3>
...
<h3 id="getinstances-with-search-expression-search-path">5.1.71 GetInstances with search expression search path</h3>
...
<h3 id="getsupporteddm-using-a-single-object-first_level_only-false-all-options">5.1.72 GetSupportedDM using a single object, first_level_only false, all options</h3>
...
<h3 id="getsupporteddm-using-a-single-object-first_level_only-true-all-options">5.1.73 GetSupportedDM using a single object, first_level_only true, all options</h3>
...
<h3 id="getsupporteddm-using-a-single-object-first_level_only-true-no-options">5.1.74 GetSupportedDM using a single object, first_level_only true, no options</h3>
...
<h3 id="getsupporteddm-using-multiple-objects-first_level_only-true-all-options">5.1.75 GetSupportedDM using multiple objects, first_level_only true, all options</h3>
...
<h3 id="getsupporteddm-on-root-object-all-options">5.1.76 GetSupportedDM on root object, all options</h3>
...
<h3 id="getsupporteddm-on-unsupported-object">5.1.77 GetSupportedDM on unsupported object</h3>
...
<h2 id="authentication-and-access-control-test-cases">5.2 Authentication and Access Control Test Cases</h2>
<h3 id="agent-does-not-accept-messages-from-its-own-endpoint-id">5.2.1 Agent does not accept messages from its own Endpoint ID</h3>
...
<h3 id="agent-rejects-messages-that-do-not-contain-its-to_id-in-the-usp-record">5.2.2 Agent rejects messages that do not contain its to_id in the USP Record</h3>
...
<h3 id="agent-does-not-process-messages-without-s-certificate-information">5.2.3 Agent does not process messages without ’s certificate information</h3>
...
<h3 id="agent-rejects-messages-from-endpoint-ids-that-are-not-in-subjectaltname">5.2.4 Agent rejects messages from Endpoint IDs that are not in subjectAltName</h3>
...
<h3 id="agent-use-of-self-signed-certificates">5.2.5 Agent use of self-signed certificates</h3>
...
<h3 id="connecting-without-absolute-time">5.2.6 Connecting without absolute time</h3>
...
<h3 id="agent-ignores-unsigned-or-invalid-record-signatures">5.2.7 Agent ignores unsigned or invalid Record signatures</h3>
...
<h3 id="agent-ignores-invalid-tls-certificate">5.2.8 Agent ignores invalid TLS certificate</h3>
...
<ol type="1">
<li>Send a Get message to the EUT with an invalid TLS certificate.</li>
</ol>
<h4 id="test-metrics-84">Test Metrics</h4>
<ol type="1">
<li>The EUT doesn’t respond to the Get message.</li>
</ol>
<h3 id="use-of-the-untrusted-role">5.2.9 Use of the Untrusted role</h3>
...
<h3 id="adding-a-role">5.2.10 Adding a Role</h3>
...
<h3 id="permissions---object-creation-allowed">5.2.11 Permissions - Object Creation Allowed</h3>
...
<h3 id="permissions---object-creation-not-allowed">5.2.12 Permissions - Object Creation Not Allowed</h3>
...
<h3 id="permissions---object-deletion-allowed">5.2.13 Permissions - Object Deletion Allowed</h3>
...
<h3 id="permissions---object-deletion-not-allowed">5.2.14 Permissions - Object Deletion Not Allowed</h3>
...
<h3 id="permissions---parameter-update-allowed">5.2.15 Permissions - Parameter Update Allowed</h3>
...
<h3 id="permissions---parameter-update-not-allowed">5.2.16 Permissions - Parameter Update Not Allowed</h3>
...
<h3 id="permissions---operation-allowed">5.2.17 Permissions - Operation Allowed</h3>
...
<h3 id="permissions---operation-not-allowed">5.2.18 Permissions - Operation Not Allowed</h3>
...
<h3 id="permissions---value-change-notification-allowed-on-parameter">5.2.19 Permissions - Value Change Notification Allowed on Parameter</h3>
...
<h3 id="permissions---value-change-notification-not-allowed-on-parameter">5.2.20 Permissions - Value Change Notification Not Allowed on Parameter</h3>
...
<h3 id="permissions---overlapping-permissions">5.2.21 Permissions - Overlapping Permissions</h3>
...
<h3 id="using-get-when-no-read-permissions-are-available-on-some-parameters">5.2.22 Using Get when no read permissions are available on some parameters</h3>
...
<h2 id="usp-record-test-cases">5.9 USP Record Test Cases</h2>
<h3 id="bad-request-outside-a-session-context">5.3.1 Bad request outside a session context</h3>
...
<h3 id="agent-protects-usp-record-integrity-when-mtp-protection-is-not-present">5.3.2 Agent protects USP Record integrity when MTP protection is not present</h3>
<h4 id="purpose-100">Purpose</h4>
<p>The purpose of this test is to ensure the EUT protects the non-payload portion of a USP Record when MTP protections are not present.</p>
<h4 id="functionality-tags-22">Functionality Tags</h4>
<p>Conditional Mandatory (supports integrity protection at the USP layer)</p>
...
<li>Validate the integrity of the non-payload fields in the USP Record using the mac_signature.</li>
</ol>
<h4 id="test-metrics-100">Test Metrics</h4>
<ol type="1">
<li>The USP Record containing the GetResponse has a valid mac_signature value.</li>
</ol>
<h3 id="agent-verifies-non-payload-field-integrity">5.3.3 Agent Verifies Non-Payload Field Integrity</h3>
...
<ol type="1">
<li>Send a Get message to the EUT with a <code>payload_security</code> of PLAINTEXT and an invalid <code>mac_signature</code> value.</li>
</ol>
<h4 id="test-metrics-101">Test Metrics</h4>
<ol type="1">
<li>After the EUT receives the USP record with the invalid mac_signature, it exibits the expected “bad request” behavior for the applicable MTP.</li>
</ol>
<h3 id="using-tls-for-usp-record-integrity">5.3.4 Using TLS for USP Record Integrity</h3>
...
<h3 id="failure-to-establish-tls">5.3.5 Failure to Establish TLS</h3>
...
<ol type="1">
<li>Configure the controller to use TLS as a <code>payload_security</code>.</li>
...
<h3 id="agent-ignores-tls-renegotiation-for-e2e-message-exchange">5.3.6 Agent ignores TLS renegotiation for E2E message exchange</h3>
...
<h3 id="use-of-x.509-certificates">5.3.7 Use of X.509 Certificates</h3>
...
<h3 id="establishing-a-session-context">5.3.8 Establishing a Session Context</h3>
...
<h3 id="receipt-of-a-record-out-of-a-session-context">5.3.9 Receipt of a Record out of a Session Context</h3>
...
<h3 id="session-context-expiration">5.3.10 Session Context Expiration</h3>
...
<h3 id="use-of-sequence-id-and-expected-id">5.3.11 Use of Sequence ID and Expected ID</h3>
...
<h3 id="preservation-of-usp-records">5.3.12 Preservation of USP Records</h3>
...
<h3 id="agent-rejects-records-with-different-payload-security-than-the-established-context">5.3.13 Agent Rejects Records with Different Payload Security than the Established Context</h3>
...
<h3 id="use-of-retransmit_id">5.3.14 Use of retransmit_id</h3>
...
<h3 id="handling-duplicate-records">5.3.15 Handling Duplicate Records</h3>
...
<h2 id="general-mtp-test-cases">5.4 General MTP Test Cases</h2>
<h3 id="use-of-x.509-certificates-at-the-mtp-layer">5.4.1 Use of X.509 certificates at the MTP layer</h3>
...
<h2 id="coap-test-cases">5.5 CoAP Test Cases</h2>
<h3 id="mapping-a-usp-record-to-a-coap-message">5.5.1 Mapping a USP Record to a CoAP message</h3>
...
<h3 id="usp-records-that-exceed-coap-message-size">5.5.2 USP Records that exceed CoAP message size</h3>
...
<h3 id="successful-coap-exchange">5.5.3 Successful CoAP exchange</h3>
...
<h3 id="failed-coap-exchange---timeout">5.5.4 Failed CoAP exchange - timeout</h3>
...
<h3 id="failed-coap-exchange---invalid-method">5.5.5 Failed CoAP Exchange - Invalid Method</h3>
...
<h3 id="failed-coap-exchange---invalid-content-format">5.5.6 Failed CoAP Exchange - Invalid Content-Format</h3>
...
<h3 id="failed-coap-exchange---invalid-usp-record">5.5.7 Failed CoAP Exchange - Invalid USP Record</h3>
...
<h3 id="use-of-dtls">5.5.8 Use of DTLS</h3>
...
<h2 id="stomp-test-cases">5.6 STOMP Test Cases</h2>
<h3 id="support-of-required-profiles">5.6.1 Support of Required Profiles</h3>
...
<h3 id="stomp-session-establishment">5.6.2 STOMP session establishment</h3>
...
<h3 id="stomp-connection-retry">5.6.3 STOMP Connection Retry</h3>
...
<h3 id="successful-usp-message-over-stomp-with-required-headers">5.6.4 Successful USP message over STOMP with required headers</h3>
...
<h3 id="stomp-destination---provided-in-subscribe-dest">5.6.5 STOMP destination - provided in subscribe-dest</h3>
...
<h3 id="stomp-destination---configured-in-usp-data-model">5.6.6 STOMP destination - configured in USP data model</h3>
...
<h3 id="stomp-destination---terminates-unconfigured-session">5.6.7 STOMP Destination - terminates unconfigured session</h3>
...
<h3 id="use-of-stomp-heartbeat-mechanism">5.6.8 Use of STOMP heartbeat mechanism</h3>
...
<h3 id="error-handling---unprocessed-record">5.6.9 Error Handling - Unprocessed Record</h3>
...
<h3 id="agents-stomp-destination-is-changed">5.6.10 Agent’s STOMP destination is changed</h3>
...
<h3 id="stomp---use-of-tls">5.6.11 STOMP - Use of TLS</h3>
...
<h2 id="websocket-test-cases">5.7 WebSocket Test Cases</h2>
<h3 id="session-establishment">5.7.1 Session Establishment</h3>
...
<h3 id="use-of-only-one-session">5.7.2 Use of only one session</h3>
...
<h3 id="agent-session-acceptance-from-controller">5.7.3 Agent session acceptance from Controller</h3>
...
<h3 id="closing-a-websocket-connection">5.7.4 Closing a WebSocket Connection</h3>
...
<h3 id="rejection-of-session-establishment">5.7.5 Rejection of Session Establishment</h3>
...
<h3 id="error-handling---unprocessed-records">5.7.6 Error Handling - Unprocessed Records</h3>
...
<h3 id="use-of-ping-and-pong-frames">5.7.7 Use of Ping and Pong frames</h3>
...
<h3 id="websocket-session-retry">5.7.8 WebSocket Session Retry</h3>
...
<h3 id="use-of-tls">5.7.9 Use of TLS</h3>
...
<h2 id="discovery-test-cases">5.8 Discovery Test Cases</h2>
<h3 id="dhcp-discovery---agent-request-requirements">5.8.1 DHCP Discovery - Agent Request Requirements</h3>
...
<ol type="1">
<li>Reboot the EUT.</li>
<li>Wait for the EUT to requets an address via DHCP.</li>
</ol>
...
<h3 id="dhcp-discovery---agent-handling-of-recieved-options">5.8.2 DHCP Discovery - Agent handling of recieved options</h3>
...
<h3 id="dhcp-discovery---fqdn-leads-to-dns-query">5.8.3 DHCP Discovery - FQDN Leads to DNS Query</h3>
...
<ol type="1">
<li>Configure the DHCP server to provide a controller URL with a FQDN containing “.local.”.</li>
...
<h3 id="mdns-and-message-transfer-protocols">5.8.5 mDNS and Message Transfer Protocols</h3>
<h4 id="purpose-146">Purpose</h4>
<p>The purpose of this test is to ensure the EUT correctly advertises the MTPs it supports.</p>
...
<ol type="1">
<li>The EUT sends an unsolicated multicast DNS response containing in the anwser section a record for each supported MTP.</li>
</ol>
<h3 id="dns---resolving-non-local-endpoints">5.8.6 DNS - Resolving non-local endpoints</h3>
<h4 id="purpose-147">Purpose</h4>
<p>The purpose of this test is to ensure the EUT uses DNS to resolve FQDN when the domain is not applicable for resolution via mDNS.</p>
<h4 id="functionality-tags-67">Functionality Tags</h4>
<p>Mandatory</p>
<h4 id="test-setup-148">Test Setup</h4>
<ol type="1">
<li>Ensure the DHCP server providing an address to the EUT is configured to provide a FQDN for a controller that does not contain “.local.”.</li>
<li>Ensure the EUT is configured to discover controllers via DHCP.</li>
<li>Ensure the DHCP server is configured to provide a DNS server.</li>
</ol>
<h4 id="test-procedure-138">Test Procedure</h4>
<ol type="1">
<li>Reboot the EUT.</li>
<li>Allow the EUT to acquire an address.</li>
<li>Wait for the EUT to send a DNS query for the FQDN acquired during DHCP controller discovery.</li>
</ol>
<h4 id="test-metrics-149">Test Metrics</h4>
<ol type="1">
<li>After the EUT receives a FQDN via DHCP controller discovery, it uses DNS to resolve the FQDN.</li>
</ol>
<h3 id="dns---unknown-resource-path">5.8.7 DNS - Unknown Resource Path</h3>
<h4 id="purpose-148">Purpose</h4>
<p>The purpose of this test is to ensure the EUT used DNS-SD information about a controller when the resource path is not known.</p>
<h4 id="functionallity-tags">Functionallity Tags</h4>
<p>Mandatory</p>
<h4 id="test-setup-149">Test Setup</h4>
<ol type="1">
<li>Configure the DHCP server to provide a FQDN that the EUT has never seen before.</li>
<li>Ensure the EUT is configured to discover controllers via DHCP.</li>
</ol>
<h4 id="test-procedure-139">Test Procedure</h4>
<ol type="1">
<li>Reboot the EUT.</li>
<li>Allow the EUT to acquire an address via DHCP.</li>
<li>Wait for the EUT to use DNS to resolve the FQDN.</li>
<li>Wait for the EUT to request DNS-SD information.</li>
</ol>
<h4 id="test-metrics-150">Test Metrics</h4>
<ol type="1">
<li>The EUT requests uses a DNS service discovery mechanism to request additional information about the controller.</li>
</ol>
<h3 id="dns---dns-record-requirements">5.8.8 DNS - DNS Record Requirements</h3>
...
<h2 id="functionality-test-cases">5.9 Functionality Test Cases</h2>
<h3 id="use-of-the-timer-event">5.9.1 Use of the Timer! Event</h3>
...
<h3 id="use-of-device.localagent.addcertificate">5.9.2 Use of Device.LocalAgent.AddCertificate()</h3>
...
<h3 id="upgraded-the-agents-firmware---autoactivate-enabled">5.9.3 Upgraded the Agent’s Firmware - Autoactivate enabled</h3>
...
<h3 id="upgrading-the-agents-firmware---using-timewindow-immediate">5.9.4 Upgrading the Agent’s Firmware - Using TimeWindow, Immediate</h3>
...
<h3 id="upgrading-the-agents-firmware---using-timewindow-anytime">5.9.5 Upgrading the Agent’s Firmware - Using TimeWindow, AnyTime</h3>
...
<h3 id="upgrading-the-agents-firmware---validated-firmware">5.9.6 Upgrading the Agent’s Firmware - Validated Firmware</h3>
...
<h3 id="upgrading-the-agents-firmware---download-to-active-bank">5.9.7 Upgrading the Agent’s Firmware - Download to Active Bank</h3>
...
<h3 id="upgrading-the-agents-firmware---cancelling-a-request-using-the-cancel-command">5.9.8 Upgrading the Agent’s Firmware - Cancelling a request using the Cancel() command</h3>
...
<h3 id="adding-a-new-controller---onboardrequest">5.9.9 Adding a New Controller - OnBoardRequest</h3>
...
<h3 id="use-of-the-boot-event-and-bootparameters">5.9.10 Use of the Boot! event and BootParameters</h3>
<h4 id="purpose-159">Purpose</h4>
...
<h4 id="test-setup-159">Test Setup</h4>
<ol type="1">
<li>Ensure that the EUT and test equipment have the necessary information to send and receive USP Records to each other.</li>
</ol>
<h4 id="test-procedure-150">Test Procedure</h4>
<ol type="1">
<li>Send an Add message to the EUT with the following structure:</li>
</ol>
<pre><code>header {
...
<h4 id="test-metrics-161">Test Metrics</h4>
<ol type="1">
